...
public class HomeBean {
    ...
    private void initPackages() {
        ...
        UserServiceModel userServiceModel = this.userService.findUserByUsername((String) ((HttpSession) FacesContext
                .getCurrentInstance()
                .getExternalContext()
        ...
        this.pendingPackages = userServiceModel
                .getPackages()
                .stream()
                .filter(p -> p.getStatus().name().equals(Status.Pending.toString()))
